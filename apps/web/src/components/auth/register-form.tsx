  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div>
        ...
        <p className="text-muted-foreground text-sm">Join Aerial Cast to start monitoring your drones</p>
      </div>
      ...
      <div className="flex items-start space-x-2">
        <input
          ...
          className="w-4 h-4 mt-1 bg-background border border-border rounded cursor-pointer accent-primary"
        />
